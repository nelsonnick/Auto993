...
public class IDKit {
  ...
  public static Boolean checkID_B(String id) {
    if (id.matches("\\d{17}[0-9,X]")) {
      if (checkBirth(id)) {
        if (checkOut(id)) {
          return true;
  ...
  public static String checkIDDetail(String id) {
    if (id.matches("\\d{17}[0-9,X]")) {
      if (checkArea(id)) {
        if (checkBirth(id)) {
          if (checkOut(id)) {
  ...
  public static boolean checkIDDetailB(String id) {
    if (id.matches("\\d{17}[0-9,X]")) {
      if (checkArea(id)) {
        if (checkBirth(id)) {
          if (checkOut(id)) {
  ...
  private static boolean checkArea(String id) {
    ...
    return areaCode.containsKey(id.substring(0, 4));
  }

  private static boolean checkBirth(String id) {
    String Birth = id.substring(6, 10) + "-"
  ...
  private static boolean checkOut(String id) {
    int i = (Integer.parseInt(id.substring(0, 1)) * 7
            ...
            + Integer.parseInt(id.substring(15, 16)) * 4 + Integer
            .parseInt(id.substring(16, 17)) * 2) % 11;
    return (i == 0 && id.substring(17, 18).equals("1"))
            || (i == 1 && id.substring(17, 18).equals("0"))
            || (i == 2 && id.substring(17, 18).equals("X"))
            || (i == 3 && id.substring(17, 18).equals("9"))
            || (i == 4 && id.substring(17, 18).equals("8"))
            || (i == 5 && id.substring(17, 18).equals("7"))
            || (i == 6 && id.substring(17, 18).equals("6"))
            || (i == 7 && id.substring(17, 18).equals("5"))
            || (i == 8 && id.substring(17, 18).equals("4"))
            || (i == 9 && id.substring(17, 18).equals("3"))
            || (i == 10 && id.substring(17, 18).equals("2"));
  }
...
//	}
  ...
  public static int getSex(String id) {
    if (id.substring(16, 17).equals("1")
            ...
            || id.substring(16, 17).equals("5")
            || id.substring(16, 17).equals("7")
            || id.substring(16, 17).equals("9")) {
      return 1;// 男
    }
    return 2;// 女
  }
  ...
  public static String getRetireMonth(String id, Date DocunmentBirth) {
    ...
    if (id.substring(6, 14).equals(str)) {
      if (getSex(id) == 1) {
        int ryear = Integer.parseInt(id.substring(6, 10)) + 60;
        int rmonth = Integer.parseInt(id.substring(10, 12));
        if (rmonth > 9) {
        ...
        int ryear = Integer.parseInt(id.substring(6, 10)) + 50;
        int rmonth = Integer.parseInt(id.substring(10, 12));
        if (rmonth > 9) {
          String r = String.valueOf(ryear)
                  + Integer.parseInt(id.substring(10, 12));
  ...
  public static Date getBirthDate(String id) {
    ...
    try {
      Date date = sdf.parse(id.substring(6, 10) + "-"
              + id.substring(10, 12) + "-"
              + id.substring(12, 14));
      return date;
