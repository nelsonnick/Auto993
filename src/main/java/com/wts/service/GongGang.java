...
import static com.wts.function.security.Security.getDWMC;
...
public class GongGang {
   ...
   * @return 提示字符串
   */
  public static String check(CloseableHttpClient client, PersonGG personGG, String qsny, String zzny) throws Exception {
    ...
    return personGG.getGmsfhm() + personGG.getGrxm() + "--" + qsny + "-" + zzny + "补贴未录入";
  }
   ...
   * @return 提示字符串
   */
  public static String save(CloseableHttpClient client, PersonGG personGG, String qsny, String zzny) throws Exception {
    if (!checkID_B(personGG.getGmsfhm())) {
      System.out.println(personGG.getGmsfhm() + personGG.getGrxm() + "--身份证号码错误！");
      return "身份证号码错误！";
    }
    ...
    sfyxffylbt = jsStr.getString("sfyxffylbt");
    sfyxffyilbt = jsStr.getString("sfyxffyilbt");
    String save = saveSubsidy(client, personGG.getGmsfhm(), personGG.getGrbh(), personGG.getDjlsh(), qsny, zzny, syys, yanglaobz, yiliaobz, shiyebz, gangweibz, sfyxyq, sfyxffylbt, sfyxffyilbt);
    if (!save.equals("保存成功！")) {
      return "保存错误，提示信息为：" + save;
    }
    System.out.println(personGG.getGmsfhm() + personGG.getGrxm() + "--" + qsny + "-" + zzny + "补贴录入成功");
    return personGG.getGmsfhm() + personGG.getGrxm() + "--" + qsny + "-" + zzny + "补贴录入成功";
  }
